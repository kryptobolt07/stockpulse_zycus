                    ...
                    <div className="flex items-center justify-end gap-2 flex-wrap">
                      ...
                      <div className="flex items-center bg-indigo-50/60 dark:bg-indigo-950/30 p-0.5 rounded-xl border border-indigo-200 dark:border-indigo-800/50">
                        <button
                          ...
                          disabled={isLoading || advisingProductIds.has(product.id)}
                          className={`flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-mono transition-colors ${
                            advisingProductIds.has(product.id)
                              ? 'bg-indigo-600 text-white font-bold animate-pulse'
                              : 'text-indigo-600 dark:text-indigo-400 hover:bg-white dark:hover:bg-indigo-900/50'
                          }`}
            ...
            <div key={product.id} className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                ...
                <button
                  onClick={() => onRunAiAdvisor(product.id)}
                  disabled={isLoading || advisingProductIds.has(product.id)}
                  className={`flex items-center justify-center gap-1 py-2 rounded-xl text-xs font-mono border transition-all ${
                    advisingProductIds.has(product.id)
                      ? 'bg-indigo-600 text-white font-bold animate-pulse border-indigo-600'
